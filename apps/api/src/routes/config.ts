...
export async function configRoutes(fastify: FastifyInstance) {
  fastify.get(
    ...
    async (request, reply) => {
      ...
      const tiers: GpuTier[] = ['H100', 'H200', 'L40S', 'B200', 'B300', 'GB300', 'CONSUMER', 'RTX_4090', 'RTX_3090']
  ...
  fastify.delete(
    ...
    async (request, reply) => {
      ...
      if (!['H100', 'H200', 'L40S', 'B200', 'B300', 'GB300', 'CONSUMER', 'RTX_4090', 'RTX_3090'].includes(gpuTier)) {
        return reply.code(400).send({
          error: 'Validation Error',

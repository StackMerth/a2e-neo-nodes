...
import {
  ...
  buyerComputeRoutes,
  buyerConfidentialInterestRoutes,
  adminComputeRoutes,
  portalWithdrawalRoutes,
  adminWithdrawalRoutes,
  adminBuyerWithdrawalRoutes,
  adminBalanceRoutes,
  adminUbiRoutes,
  portalUbiRoutes,
  paymentConfigRoutes,
...
async function start() {
  try {
    ...
    await server.register(buyerConfidentialInterestRoutes)
    ...
    await server.register(adminBuyerWithdrawalRoutes)
    await server.register(adminBalanceRoutes)
    await server.register(adminUbiRoutes)
    await server.register(portalUbiRoutes)

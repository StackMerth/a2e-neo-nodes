...
const features = [
  {
    number: "01",
    title: "Sub-minute allocation",
    description: "Pay, then SSH. The auto-allocator watches confirmed payments every ten seconds, picks an idle GPU matching your tier and region, and hands back credentials in under sixty seconds.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Reputation that is earned, not bought",
    description: "Every operator carries a transparent score: 60 percent uptime, 25 percent buyer ratings, 15 percent completed jobs. The formula is public. The math is public. There is no pay-to-rank.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Per-minute billing, refunds for what you did not use",
    description: "Stop in the middle of a job and the unused minutes return to your wallet. The settlement runs on Solana, median eleven seconds end-to-end.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Ephemeral SSH, no shared keys",
    description: "Every rental gets a fresh session credential that expires when the rental does. No long-lived passwords, no operator can replay your access after you leave.",
    visual: "security",
  },
];
...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-16 p-6 sm:p-8 lg:p-12 border border-foreground/15 rounded-sm hover:border-foreground/25 transition-colors">
        {/* Number */}
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-36 h-32 sm:w-44 sm:h-36 lg:w-48 lg:h-40 text-brand">
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        {/* Features List, each a bordered card */}

...
#
# Usage: curl -sSL https://a2e.byredstone.com/install.sh | bash
...
# Configuration
DOWNLOAD_BASE_URL="${A2E_DOWNLOAD_URL:-https://a2e.byredstone.com/releases}"
...
configure_interactive() {
    ...
    # API URL
    read -p "A²E API URL [https://a2e.byredstone.com]: " api_url
    api_url="${api_url:-https://a2e.byredstone.com}"
